...
app.config['MYSQL_DB'] = 'Kliiker'         # Nombre de la base de datos
app.config['MYSQL_CURSORCLASS'] = 'DictCursor'  # Tipo de cursor que retorna resultados como diccionarios
    ...
    try:
        ...
        with app.app_context():
            ...
            for registro in datos:
                ...
                try:
                    fecha_mysql = datetime.strptime(fecha_original, "%d/%m/%Y").strftime("%Y-%m-%d")
                except ValueError:
